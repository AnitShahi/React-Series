    ...
    <div className="w-full h-screen duration-200" style={{backgroundColor: color}}>
      ...
      <div className="fixed flex flex-wrap justify-center bottom-12 inset-x-0 px-2">
        <div className="flex flex-wrap justify-center gap-3 shadow-lg bg-white px-3 py-2 rounded-3xl">
          ...
          <button onClick={() => setColor("yellow")} className="outline-none px-4 rounded-full shadow-lg" style={{backgroundColor:"yellow"}}>Yellow</button>
          <button onClick={() => setColor("pink")} className="outline-none px-4 rounded-full shadow-lg" style={{backgroundColor:"pink"}}>Pink</button>
          ...
          <button onClick={() => setColor("lavender")} className="outline-none px-4 rounded-full shadow-lg" style={{backgroundColor:"lavender"}}>Lavender</button>
